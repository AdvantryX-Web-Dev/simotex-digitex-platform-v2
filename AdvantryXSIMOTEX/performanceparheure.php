                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Performance horaire:</h6>
                            <form action="./fichierExcel/performanceH.php" method="post" id="filterForm">
                                <div class="col-md-3 float-right">
                                    <button type="submit" name="submit"
                                        class="btn btn-primary float-right">Telecharger</button>
                                </div>
                                <div class="col-md-3 float-right">
                                    <select name="prod_line" id="prod_line" class="form-control"> Chaine de Production
                                        <option>Tous</option>
                                        <?php
                                ...
                                <div class="col-md-3 float-right">
                                    <input type="date" id="date" name="date" class="form-control float-right">
                                </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Rendement </th>
                                            <!-- <th>Performance en nombre des piéces </th> -->
                                            <th>Date</th>
                                            <th>Heure</th>
                                    ...
                                    INNER JOIN `init__employee` ON `prod__operator_perf_hr`.`operator` = `init__employee`.`matricule` WHERE `prod__operator_perf_hr`.`cur_date`= CURRENT_DATE GROUP BY `prod__operator_perf_hr`.`operator`, `prod__operator_perf_hr`.`cur_date`, `prod__operator_perf_hr`.`cur_time`;";
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById("filterForm").addEventListener("submit", function(event) {
                ...
                var group = document.getElementById("prod_line").value.trim();
